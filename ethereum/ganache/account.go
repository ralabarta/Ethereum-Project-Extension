...
func (G *Ganache) NewAccount() {
	...
	fmt.Println("privateKeyBytes", hexutil.Encode(
		privateKeyBytes)[2:]) // 0xfad9c8855b740a0b7ed4c221dbad0f33a83a49cad6b3fe8d5817ac83d38b6a19
	...
	fmt.Println("NewLegacyKeccak", hexutil.Encode(hash.Sum(nil)[12:])) // 0x96216849c49358b10257cb55b28ea603c874b05e
}
